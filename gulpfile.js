...
const copyHTML = () =>
  gulp.src("src/**/*.html", { encoding: false }).pipe(gulp.dest("dist"));
const copyJs = () =>
  gulp.src("src/**/*.js", { encoding: false }).pipe(gulp.dest("dist"));
const copyImg = () =>
  gulp
...
export const build = gulp.series(
  gulp.parallel(compileSass, copyHTML, copyImg, copyJs)
);
